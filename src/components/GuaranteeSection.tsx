...
const GuaranteeSection: React.FC = () => {
  return <section id="garantia" className="section-padding bg-gradient-to-b from-white to-pink-50 relative overflow-hidden">
            ...
            <div className="md:col-span-3">
              <div className="mb-6">
                ...
                <div className="p-4 bg-green-50 border border-green-100 rounded-lg mb-8">
                  <p className="text-sm text-green-800">Caso você não fique satisfeito com a lista, por qualquer motivo, basta solicitar o reembolso dentro do prazo de 7 dias e devolveremos 100% do seu dinheiro. Sem perguntas!</p>
                </div>
